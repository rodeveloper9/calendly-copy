                                ...
                                <p className="calenderView_dateTime_timeView_listItemWrap" onClick={() => handleTimeClick()}>
                                    {cnfrmBtn ?
                                        <p className="calenderView_dateTime_timeView_listItemCnfrm">
                                            <span className="calenderView_dateTime_timeView_listItemCnfrm_time">09:00am</span> <span className="calenderView_dateTime_timeView_listItemCnfrm_btn" onClick={() => handleConfirmClick()}>Confirm</span></p>
